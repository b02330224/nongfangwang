...
Revision ID: b5d0e9d8fd9d
Revises: 
Create Date: 2020-07-23 10:32:36.469433
...
def upgrade():
    ...
    sa.Column('pay_period', sa.Integer(), nullable=True),
    ...
    sa.Column('facility2_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['facility2_id'], ['ihome_facility2.id'], ),
    sa.ForeignKeyConstraint(['factory_id'], ['ihome_factory.id'], ),
    sa.PrimaryKeyConstraint('factory_id', 'facility2_id')
    )
